...
(async () => {
    ...
    comp.tXForgotPassword = class {
        ...
        #postMobileAsync = async() => {
            return await new tX.el().postAsync('body', {
                'elementType': 'h3'
                , 'elementId': 'comp'
                , 'text': 'Your mobile forgot password goes here'
                , 'classList': [], 'style': {}
            });
        }
        //#endregion mobile
        ...
        #postTabletAsync = async() => {
            return await new tX.el().postAsync('body', {
                'elementType': 'h3'
                , 'elementId': 'comp'
                , 'text': 'Your tablet forgot password goes here'
                , 'classList': [], 'style': {}
            });
        }
        //#endregion tablet
        ...
        #postDesktopAsync = async() => {
            return await new tX.el().postAsync('body', {
                'elementType': 'h3'
                , 'elementId': 'comp'
                , 'text': 'Your desktop forgot password goes here'
                , 'classList': [], 'style': {}
            });
        }
        //#endregion desktop
    ...
    return await new comp.tXForgotPassword().postAsync().then(async compEl => {});
})();