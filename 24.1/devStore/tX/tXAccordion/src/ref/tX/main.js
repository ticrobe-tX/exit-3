...
(async () => {
    ...
    comp.tXAccordion = class {
        ...
        #postMobileAsync = async() => {
            return await new tX.el().postAsync('body', {
                'elementType': 'h3'
                , 'elementId': 'comp'
                , 'text': 'Your mobile accordion goes here'
                , 'classList': [], 'style': {}
            });
        }
        //#endregion mobile
        ...
        #postTabletAsync = async() => {
            return await new tX.el().postAsync('body', {
                'elementType': 'h3'
                , 'elementId': 'comp'
                , 'text': 'Your tablet accordion goes here'
                , 'classList': [], 'style': {}
            });
        }
        //#endregion tablet
        ...
        #postDesktopAsync = async() => {
            return await new tX.el().postAsync('body', {
                'elementType': 'h3'
                , 'elementId': 'comp'
                , 'text': 'Your desktop accordion goes here'
                , 'classList': [], 'style': {}
            });
        }
        //#endregion desktop
    ...
    return await new comp.tXAccordion().postAsync().then(async compEl => {});
})();