...
(async () => {
    ...
    comp.tXDataGrid = class {
        ...
        #postMobileAsync = async() => {
            return await new tX.el().postAsync('body', {
                'elementType': 'h3'
                , 'elementId': 'comp'
                , 'text': 'Your mobile data grid goes here'
                , 'classList': [], 'style': {}
            });
        }
        //#endregion mobile
        ...
        #postTabletAsync = async() => {
            return await new tX.el().postAsync('body', {
                'elementType': 'h3'
                , 'elementId': 'comp'
                , 'text': 'Your tablet data grid goes here'
                , 'classList': [], 'style': {}
            });
        }
        //#endregion tablet
        ...
        #postDesktopAsync = async() => {
            return await new tX.el().postAsync('body', {
                'elementType': 'h3'
                , 'elementId': 'comp'
                , 'text': 'Your desktop data grid goes here'
                , 'classList': [], 'style': {}
            });
        }
        //#endregion desktop
    ...
    return await new comp.tXDataGrid().postAsync().then(async compEl => {});
})();