...
(async () => {
    ...
    comp.tXRegister = class {
        ...
        #postMobileAsync = async() => {
            return await new tX.el().postAsync('body', {
                'elementType': 'h3'
                , 'elementId': 'comp'
                , 'text': 'Your mobile register goes here'
                , 'classList': [], 'style': {}
            });
        }
        //#endregion mobile
        ...
        #postTabletAsync = async() => {
            return await new tX.el().postAsync('body', {
                'elementType': 'h3'
                , 'elementId': 'comp'
                , 'text': 'Your tablet register goes here'
                , 'classList': [], 'style': {}
            });
        }
        //#endregion tablet
        ...
        #postDesktopAsync = async() => {
            return await new tX.el().postAsync('body', {
                'elementType': 'h3'
                , 'elementId': 'comp'
                , 'text': 'Your desktop register goes here'
                , 'classList': [], 'style': {}
            });
        }
        //#endregion desktop
    ...
    return await new comp.tXRegister().postAsync().then(async compEl => {});
})();